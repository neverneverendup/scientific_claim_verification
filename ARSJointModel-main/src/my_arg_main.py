...
from train_model import train_base, arg_train_base, get_arg_predictions
...
def main():
    ...
    if args.state == 'train':
        args.checkpoint = arg_train_base(train_set, dev_set, test_set, args)
    if args.state == 'prediction':
        #args.checkpoint = 'model/RoBerta_large_w.model'
        pass
    print('model:', args.checkpoint)

    abstract_result, rationale_result, retrieval_result = get_arg_predictions(args, test_set, args.checkpoint)
