...
from train_model import train_base , abstract_rationale_train_base
from get_prediction import get_predictions, get_abstract_rationale_predictions
from dataset.utils import merge, merge_retrieval
from utils import predictions2jsonl, retrieval2jsonl, rationale2jsonl
...
def main():
    ...
    if args.state == 'train':
        ...
        args.checkpoint = abstract_rationale_train_base(train_set, dev_set, args)
    ...
    rationale_result, retrieval_result = get_abstract_rationale_predictions(args, test_set, args.checkpoint)
    rationales = rationale2jsonl(test_set.samples, rationale_result)
