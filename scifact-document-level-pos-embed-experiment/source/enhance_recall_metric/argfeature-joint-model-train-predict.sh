...
CUDA_VISIBLE_DEVICES=0 python -u argfeature_joint_paragraph_dynamic_model_predict.py \
--repfile roberta-large \
--corpus_file ../../data/para_scifact/corpus.jsonl \
...
--output_dir ./model/biosent_dev_best-argfeature-tfidf-torch17-loss-ratio-6_joint_arg_model_k12 \
#> torch17_joint_arg_model_test_predict.txt 2>&1 &
