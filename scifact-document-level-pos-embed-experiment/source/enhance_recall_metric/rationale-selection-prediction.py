...
from util import stance2json, rationale2json, merge_json
...
if __name__ == "__main__":
    ...
    argparser.add_argument('--test_file', type=str, default="/home/xxl190027/scifact_data/claims_dev_biosent_retrieved.jsonl")
