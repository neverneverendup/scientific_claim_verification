...
#--max_seq_length 512 \
#--update_step 10 \
#--abstract_lambda 0.922272 \
#--rationale_lambda 11.213410 \
#--repfile roberta-large \
#--output_dir ./model/optuna-roberta-abslam-0.922272-rationlam-11.213410-tfidf-torch17-joint_arg_model_k12 \
#> optuna-roberta-abslam-0.922272-rationlam-11.213410-torch17-joint_arg_model_k12.txt 2>&1 &


CUDA_VISIBLE_DEVICES=0 /home/LAB/r-chaowenhan/anaconda3/envs/scifact/bin/python -u argfeature_joint_paragraph_dynamic_model_train.py \
--corpus_file ../../data/para_scifact/corpus.jsonl \
--train_file ../../data/para_scifact/claims_dev_tfidf_retrieved.jsonl \
--test_file ../../data/para_scifact/claims_dev_tfidf_retrieved.jsonl \
--bert_lr 1e-5 \
--lr 5e-6 \
--dropout 0 \
...
--rationale_lambda 6 \
--repfile roberta-large \
--output_dir ./model/get-abstract-length-tfidf-torch17-joint_arg_model_k12 \
#> get-abstract-length-torch17-joint_arg_model_k12.txt 2>&1 &