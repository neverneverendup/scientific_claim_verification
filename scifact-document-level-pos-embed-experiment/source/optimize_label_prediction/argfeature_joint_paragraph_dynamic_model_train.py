...
if __name__ == "__main__":
    ...
    model = FreezeStanceArgJointParagraphClassifier(bert_path=args.repfile, bert_dim=args.bert_dim, dropout = args.dropout, arg_feature_size = len(role_type), sentence_repr_size = args.sent_repr_dim)#.to(device)
