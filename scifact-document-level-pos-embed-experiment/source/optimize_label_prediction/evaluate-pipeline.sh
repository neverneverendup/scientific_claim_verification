...
then
    ...
    $PYTHON_SCRIPT fever_scifact_stance_paragraph_prediction.py \
        --repfile roberta-large \
        --corpus_file ../../data/para_scifact/corpus.jsonl \
        --test_file ../../data/para_scifact/claims_${dataset}_${retrieval}_retrieved.jsonl \
        --dropout 0 \
        --bert_dim 1024 \
        --k 3 \
        --train_batch_size 2 \
        --eval_batch_size 25 \
        --max_seq_length 512 \
        --checkpoint ../../../../paragraphJointModel/fever_pretrained_para_stance_model/train_with_dev_scifact_roberta_stance_paragraph.model \
        --output_dir ${model_dir}
fi
