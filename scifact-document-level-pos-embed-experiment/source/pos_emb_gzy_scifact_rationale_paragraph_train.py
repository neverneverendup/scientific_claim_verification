...
from my_models import ArgRationaleParagraphClassifier,ParagraphPosEmbRationaleParagraphClassifier
...
if __name__ == "__main__":
    ...
    dev_set = SciFactParagraphBatchDataset(args.corpus_file, args.test_file,
                                           sep_token=tokenizer.sep_token, k=args.k, dummy=False,eval=True)
    ...
    model = ParagraphPosEmbRationaleParagraphClassifier(bert_path=args.repfile, bert_dim=args.bert_dim, dropout = args.dropout, max_doc_length=42, pos_emd_dim = 1024)
