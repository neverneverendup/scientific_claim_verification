...
if __name__ == "__main__":
    ...
    model = ArgJointParagraphClassifier(bert_path=args.repfile, bert_dim=args.bert_dim, dropout=args.dropout,
                                        arg_feature_size=len(role_type),
    ...
    if test:
        ...
        test_set = TruncateArgSciFactParagraphBatchDataset(args.corpus_file, args.test_file, discard_role_classes=["METHODS","OBJECTIVE"],
        ...
        test_set = TruncateArgSciFactParagraphBatchDataset(args.corpus_file, '../../data/para_scifact/claims_dev_biosent_retrieved.jsonl', discard_role_classes=["METHODS","OBJECTIVE"],
