...
CUDA_VISIBLE_DEVICES=0 nohup /home/LAB/r-chaowenhan/anaconda3/envs/scifact/bin/python -u rationale_selection_paragraph_encoding_train.py \
--repfile roberta-large \
--corpus_file ../../data/para_scifact/corpus.jsonl \
...
--max_seq_length 512 \
--update_step 10 \
--output_dir ./model/arg_roberta-large-tfidf_model_k12_use_ref > arg_roberta-large-tfidf_model_k12_use_ref.txt 2>&1 &
