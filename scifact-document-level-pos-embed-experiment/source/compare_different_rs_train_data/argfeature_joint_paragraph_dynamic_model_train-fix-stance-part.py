...
from my_models import ArgJointParagraphClassifier, AvgRepArgJointParagraphClassifier, ArgRepArgJointParagraphClassifier, AllRepArgJointParagraphClassifier
...
if __name__ == "__main__":
    ...
    argparser.add_argument('--stance_part_type', type=str)
    ...
    if args.stance_part_type == 'avg':
        model = AvgRepArgJointParagraphClassifier(bert_path=args.repfile, bert_dim=args.bert_dim, dropout = args.dropout, arg_feature_size = len(role_type), sentence_repr_size = args.sent_repr_dim)#.to(device)
    elif args.stance_part_type == 'arg':
        model = ArgRepArgJointParagraphClassifier(bert_path=args.repfile, bert_dim=args.bert_dim, dropout = args.dropout, arg_feature_size = len(role_type), sentence_repr_size = args.sent_repr_dim)#.to(device)
    elif args.stance_part_type == 'all':
        model = AllRepArgJointParagraphClassifier(bert_path=args.repfile, bert_dim=args.bert_dim, dropout = args.dropout, arg_feature_size = len(role_type), sentence_repr_size = args.sent_repr_dim)#.to(device)

    # AvgRepArgJointParagraphClassifier, ArgRepArgJointParagraphClassifier, AllRepArgJointParagraphClassifier
