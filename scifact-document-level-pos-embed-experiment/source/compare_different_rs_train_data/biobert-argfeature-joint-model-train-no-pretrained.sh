...
# 基于biobert训练
CUDA_VISIBLE_DEVICES=1 nohup python -u biobert-argfeature_joint_paragraph_dynamic_model_train.py \
--corpus_file ../../data/para_scifact/corpus.jsonl \
...
--output_dir ./model/tfidf-biosent-torch17-loss-ratio-6_joint_arg_model_k12 > tfidf-biosent-torch17-loss_ratio_6_joint_arg_model_k12.txt 2>&1 &
