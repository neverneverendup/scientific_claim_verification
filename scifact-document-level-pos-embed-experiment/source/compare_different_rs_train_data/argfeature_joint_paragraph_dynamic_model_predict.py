...
'''
    ...
    if test:
        ...
        with jsonlines.open(args.output_dir + '/joint_model_rationale_predictions_on_testset.jsonl', 'w') as output:
            for result in rationale_json:
                output.write(result)


        with jsonlines.open(args.output_dir + '/joint_model_label_predictions_on_testset.jsonl', 'w') as output:
