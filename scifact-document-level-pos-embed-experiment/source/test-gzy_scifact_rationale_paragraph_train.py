...
from paragraph_model_dynamic import ArgRationaleParagraphClassifier as JointParagraphClassifier
#from my_models import ArgRationaleParagraphClassifier as JointParagraphClassifier
    ...
    with torch.no_grad():
        for batch in tqdm(DataLoader(dataset, batch_size = args.batch_size*5, shuffle=False)):
            ...
            rationale_out, rationale_loss = \
                model(encoded_dict, transformation_indices, (arg_feature,context_arg_feature),
...
if __name__ == "__main__":
    ...
    argparser.add_argument('--checkpoint', type=str, default = "./816_model/scifact_roberta_rationale_paragraph.model")
    argparser.add_argument('--log_file', type=str, default = "./816_model/openk3_rationale_paragraph_roberta_performances.jsonl")
    argparser.add_argument('--prediction', type=str, default = "./816_model/openk3_prediction_scifact_roberta_rationale_paragraph.jsonl")
    ...
    model = JointParagraphClassifier(args.repfile, args.bert_dim,
                                      args.dropout,sentence_repr_size=1024)#.to(device)
    ...
    if train:
        ...
        for epoch in range(args.epoch):
            ...
            print(f'Epoch {epoch}, rationale f1 p r: %.4f, %.4f, %.4f' % dev_score[:-1])
